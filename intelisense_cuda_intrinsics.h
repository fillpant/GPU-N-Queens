#pragma once
// This list was compiled by a third party and updated as nessesary. Thanks to: https://stackoverflow.com/a/58137486
...
///////////////////////////////////////////////////////
__device__ int min(const int, const int);
__device__ unsigned int min(const unsigned int, const unsigned int);
__device__ unsigned int min(const int, const unsigned int);
__device__ unsigned int min(const unsigned int, const int);

__device__ long int min(const long int, const long int);
__device__ unsigned long int min(const long int, unsigned const long int);
__device__ unsigned long int min(const unsigned long int, const long int);
__device__ unsigned long int min(const unsigned long int, const unsigned long int);

__device__ long long int min(const long long int, const long long int);
__device__ unsigned long long int min(const long long int, unsigned const long long int);
__device__ unsigned long long int min(const unsigned long long int, const long long int);
__device__ unsigned long long int min(const unsigned long long int, const unsigned long long int);

__device__ void __syncthreads(void);
__device__ int  __syncthreads_count(int);
__device__ int  __syncthreads_and(int);
__device__ int  __syncthreads_or(int);
__device__ void __syncwarp(void);
__device__ void __syncwarp(unsigned);
__device__ unsigned __activemask();
__device__ int __all_sync(unsigned, int);
__device__ int __any_sync(unsigned, int);
